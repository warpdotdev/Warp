...
impl View for TerminalViewZeroStateBlock {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let title = Flex::row()
            ...
            .with_child(
                Text::new(
                    t!("terminal.new_session").to_string(),
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(t!("terminal.start_agent_conversation").to_string()),
                    ],
                    |ctx| {
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(
                            t!("terminal.start_cloud_agent_conversation").to_string(),
                        ),
                    ],
                    |ctx| {
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(t!("terminal.cycle_past_commands").to_string()),
                    ],
                    |ctx| {
                ...
                keybinding_name_to_keystroke(TOGGLE_RIGHT_PANEL_BINDING_NAME, app)
            {
                items.push(render_standard_message(
                    Message::new(vec![MessageItem::clickable(
                        vec![
                            MessageItem::keystroke(keystroke),
                            MessageItem::text(t!("terminal.open_code_review").to_string()),
                        ],
                        |ctx| {
                ...
                Flex::row()
                    ...
                    .with_child(
                        Shrinkable::new(
                            ...
                            render_standard_message(
                                Message::from_text(
                                    t!("terminal.autodetect_agent_prompts").to_string(),
                                ),
                                app,
                            ),
                        )
