...
fn editor_display_name(email: Option<&str>, app: &AppContext) -> String {
    match email {
        ...
        None => t!("notebook.other_user").to_string(),
    }
}
