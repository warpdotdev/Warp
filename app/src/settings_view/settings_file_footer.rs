...
pub fn render_open_settings_file_button(
    ...
    Hoverable::new(mouse_state, move |state| {
        ...
        let label = Text::new_inline(i18n::t("settings.footer.open_settings_file"), ui_font_family, FOOTER_FONT_SIZE)
...
pub fn render_settings_error_alert(
    ...
    let open_file_button = render_alert_action_button(
        ...
        i18n::t("settings.footer.open_file").to_string(),
        /*icon=*/ None,
        /*bordered=*/ true,
    ...
    if ai_enabled {
        ...
        let fix_with_oz_button = render_alert_action_button(
            ...
            i18n::t("settings.footer.fix_with_oz").to_string(),
            Some(Icon::Oz),
            /*bordered=*/ false,
