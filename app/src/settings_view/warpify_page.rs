...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    if FeatureFlag::SSHTmuxWrapper.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            i18n::t("settings.warpify.ssh_session_detection"),
...
fn ssh_tmux_warpification_description() -> &'static str { i18n::t("settings.warpify.ssh_tmux_warpification_description") }

fn ssh_extension_install_mode_description() -> &'static str { i18n::t("settings.warpify.ssh_extension_install_mode_description") }
...
impl WarpifyPageView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let add_added_commands_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(i18n::t("settings.warpify.placeholder_command"), ctx);
            input
        });
        ...
        let add_denylisted_ssh_editor = ctx.add_typed_action_view(|ctx| {
            let mut input = SubmittableTextInput::new(ctx);
            input.set_placeholder_text(i18n::t("settings.warpify.placeholder_host"), ctx);
            input
        });
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        let mut categories = vec![
            ...
            Category::new(i18n::t("settings.warpify.subshells"), vec![Box::new(SubshellsWidget::default())])
                .with_subtitle(i18n::t("settings.warpify.subshells_description")),
        ];
        ...
        {
            categories.push(
                Category::new(i18n::t("settings.warpify.ssh"), vec![Box::new(SSHWidget::default())])
                    .with_subtitle(i18n::t("settings.warpify.ssh_description")),
            );
        }
...
impl TitleWidget {
    fn render_top_of_page(&self, appearance: &Appearance, _app: &AppContext) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_child(render_page_title(i18n::t("settings.warpify.title"), HEADER_FONT_SIZE, appearance))
    ...
    fn render_subshells_section(
        ...
        column.add_child(
            view.build_input_list(
                i18n::t("settings.warpify.added_commands"),
        ...
        column.add_child(
            view.build_input_list(
                i18n::t("settings.warpify.denylisted_commands"),
        ...
        add_setting(
            ...
            move || {
                render_body_item::<WarpifyPageAction>(
                    i18n::t("settings.warpify.warpify_ssh_sessions").into(),
                    None,
            ...
            add_setting(
                ...
                move || {
                    Container::new(render_dropdown_item(
                        appearance,
                        i18n::t("settings.warpify.install_ssh_extension"),
        ...
        add_setting(
            ...
            move || {
                ...
                column.add_child(render_body_item::<WarpifyPageAction>(
                    i18n::t("settings.warpify.use_tmux_warpification").into(),
                    Some(AdditionalInfo {
                ...
                column.add_child(
                    ui_builder
                        .paragraph(ssh_tmux_warpification_description().to_string())
                        .with_style(UiComponentStyles {
                ...
                if enable_ssh_warpification && should_prompt_ssh_tmux_wrapper {
                    ...
                    column.add_child(
                        view.build_input_list(
                            i18n::t("settings.warpify.denylisted_hosts"),
