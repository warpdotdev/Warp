...
impl CreateApiKeyModal {
    ...
    /// Builds the localized expiration dropdown options for the modal.
    ...
    /// Loads the current set of available named agents for agent-scoped keys.
    ...
    /// Rebuilds the agent dropdown from the currently available agent identities.
