...
fn invalid_domains_instructions() -> &'static str {
    i18n::t("settings.teams.invite.invalid_domains")
}

fn invite_link_toggle_instructions() -> &'static str {
    i18n::t("settings.teams.invite.link_toggle_instructions")
}
fn invite_link_domain_restrictions_instructions() -> &'static str {
    i18n::t("settings.teams.invite.domain_restrictions_instructions")
}

fn invite_by_email_expiry_instructions() -> &'static str {
    i18n::t("settings.teams.invite.email_expiry_instructions")
}
fn invalid_emails_instructions() -> &'static str {
    i18n::t("settings.teams.invite.invalid_emails")
}

fn offline_text() -> &'static str {
    i18n::t("settings.teams.offline")
}

fn limit_hit_admin_text() -> &'static str {
    i18n::t("settings.teams.limit.admin")
}
fn limit_hit_admin_not_auto_upgradeable_text() -> &'static str {
    i18n::t("settings.teams.limit.admin_not_upgradeable")
}
fn limit_hit_non_admin_text() -> &'static str {
    i18n::t("settings.teams.limit.non_admin")
}

fn delinquent_admin_non_self_serve_text() -> &'static str {
    i18n::t("settings.teams.delinquent.admin_non_self_serve")
}
fn delinquent_non_admin_text() -> &'static str {
    i18n::t("settings.teams.delinquent.non_admin")
}
fn delinquent_admin_self_serve_line_1_text() -> &'static str {
    i18n::t("settings.teams.delinquent.admin_self_serve_line1")
}
fn delinquent_admin_self_serve_line_2_prefix_text() -> &'static str {
    i18n::t("settings.teams.delinquent.admin_self_serve_line2_prefix")
}
fn delinquent_admin_self_serve_line_2_link_text() -> &'static str {
    i18n::t("settings.teams.delinquent.admin_self_serve_line2_link")
}
fn delinquent_admin_self_serve_line_2_suffix_text() -> &'static str {
    i18n::t("settings.teams.delinquent.admin_self_serve_line2_suffix")
}

fn team_limit_exceeded_admin_not_auto_upgradeable_text() -> &'static str {
    i18n::t("settings.teams.limit_exceeded.admin_not_upgradeable")
}
fn team_limit_exceeded_non_admin_text() -> &'static str {
    i18n::t("settings.teams.limit_exceeded.non_admin")
}
fn team_limit_exceeded_admin_upgradeable() -> &'static str {
    i18n::t("settings.teams.limit_exceeded.admin_upgradeable")
}
...
impl std::fmt::Display for TeamsInviteOption {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            "{}",
            match self {
                TeamsInviteOption::Link => i18n::t("settings.teams.tab.link"),
                TeamsInviteOption::Email => i18n::t("settings.teams.tab.email"),
            },
        )
    }
}
...
impl TeamsPageView {
    ...
    pub fn new(ctx: &mut ViewContext<TeamsPageView>) -> Self {
        ...
        let rename_team_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(i18n::t("settings.teams.manage.rename_placeholder"), ctx);
            input
        });
        ...
        let transfer_ownership_modal = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(i18n::t("settings.teams.manage.transfer_ownership_title").to_string()),
    ...
    fn handle_model_event(
        ...
        match event {
            ...
            UserWorkspacesEvent::EmailInviteRejected(err) => {
                self.update_team_members_state(ctx);
                self.show_error(
                    i18n::t("settings.teams.toast.failed_send_invite"),
                    Some(err),
                    ctx,
                )
            }
            ...
            UserWorkspacesEvent::ToggleInviteLinksSuccess => {
                self.show_success(i18n::t("settings.teams.toast.toggled_invite_links"), ctx);
                ctx.notify();
            }
            UserWorkspacesEvent::ToggleInviteLinksRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_toggle_invite_links"),
                    Some(err),
                    ctx,
                );
            }
            UserWorkspacesEvent::ResetInviteLinks => {
                self.show_success(i18n::t("settings.teams.toast.reset_invite_links"), ctx);
                ctx.notify();
            }
            UserWorkspacesEvent::ResetInviteLinksRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_reset_invite_links"),
                    Some(err),
                    ctx,
                );
            }
            UserWorkspacesEvent::DeleteTeamInvite => {
                self.update_team_members_state(ctx);
                self.show_success(i18n::t("settings.teams.toast.deleted_invite"), ctx);
            }
            UserWorkspacesEvent::DeleteTeamInviteRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_delete_invite"),
                    Some(err),
                    ctx,
                );
            }
            ...
            UserWorkspacesEvent::AddDomainRestrictionsRejected(err) => self.show_error(
                i18n::t("settings.teams.toast.failed_add_domain"),
                Some(err),
                ctx,
            ),
            ...
            UserWorkspacesEvent::DeleteDomainRestrictionRejected(err) => self.show_error(
                i18n::t("settings.teams.toast.failed_delete_domain"),
                Some(err),
                ctx,
            ),
            ...
            UserWorkspacesEvent::GenerateUpgradeLinkRejected(err) => self.show_error(
                i18n::t("settings.teams.toast.failed_upgrade_link"),
                Some(err),
                ctx,
            ),
            ...
            UserWorkspacesEvent::GenerateStripeBillingPortalLinkRejected(err) => self.show_error(
                i18n::t("settings.teams.toast.failed_billing_link"),
                Some(err),
                ctx,
            ),
            UserWorkspacesEvent::ToggleTeamDiscoverabilitySuccess => {
                self.show_success(i18n::t("settings.teams.toast.toggled_discoverability"), ctx);
                ctx.notify();
            }
            UserWorkspacesEvent::ToggleTeamDiscoverabilityRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_toggle_discoverability"),
                    Some(err),
                    ctx,
                );
            }
            UserWorkspacesEvent::JoinTeamWithTeamDiscoverySuccess => {
                ...
                let message = self.user_workspaces.as_ref(ctx).current_team().map_or_else(
                    || i18n::t("settings.teams.toast.joined_team").to_string(),
                    |team| {
                        i18n::t("settings.teams.toast.joined_team_named")
            ...
            UserWorkspacesEvent::JoinTeamWithTeamDiscoveryRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_join_team"),
                    Some(err),
                    ctx,
                );
            }
            ...
            UserWorkspacesEvent::TransferTeamOwnershipSuccess => {
                self.show_success(i18n::t("settings.teams.toast.transferred_ownership"), ctx);
                ctx.notify();
            }
            UserWorkspacesEvent::TransferTeamOwnershipRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_transfer_ownership"),
                    Some(err),
                    ctx,
                );
            }
            UserWorkspacesEvent::SetTeamMemberRoleSuccess => {
                self.update_team_members_state(ctx);
                self.show_success(i18n::t("settings.teams.toast.updated_member_role"), ctx);
            }
            UserWorkspacesEvent::SetTeamMemberRoleRejected(err) => {
                self.show_error(
                    i18n::t("settings.teams.toast.failed_update_member_role"),
                    Some(err),
                    ctx,
                );
            }
    ...
    fn handle_team_update_event(
        ...
        match event {
            TeamUpdateManagerEvent::LeaveError => {
                let error = i18n::t("settings.teams.toast.error_leaving_team").to_string();
                self.show_error(error, None, ctx);
            }
            TeamUpdateManagerEvent::LeaveSuccess => {
                self.show_success(i18n::t("settings.teams.toast.left_team"), ctx);
                ctx.notify();
            }
            TeamUpdateManagerEvent::RenameTeamSuccess => {
                self.show_success(i18n::t("settings.teams.toast.renamed_team"), ctx)
            }
            TeamUpdateManagerEvent::RenameTeamError => self.show_error(
                i18n::t("settings.teams.toast.failed_rename_team"),
                None,
                ctx,
            ),
        }
    ...
    fn copy_invite_link(&mut self, link: &str, ctx: &mut ViewContext<Self>) {
        ...
        self.show_toast(
            i18n::t("settings.teams.toast.link_copied"),
            ToastFlavor::Default,
            ctx,
        );
    }
    ...
    fn add_domain_restrictions(&mut self, team_uid: ServerId, ctx: &mut ViewContext<Self>) {
        ...
        if !invalid_domains.is_empty() {
            let error = i18n::t("settings.teams.toast.invalid_domain_count")
        ...
        self.show_success(
            i18n::t("settings.teams.toast.domains_added")
    ...
    fn send_email_invites(&mut self, team_uid: ServerId, ctx: &mut ViewContext<Self>) {
        ...
        if !invalid_emails.is_empty() {
            let error = i18n::t("settings.teams.toast.invalid_email_count")
        ...
        let message = if unique_emails.len() == 1 {
            i18n::t("settings.teams.toast.invite_sent").to_string()
        } else {
            i18n::t("settings.teams.toast.invites_sent")
    ...
    fn team_to_item_list(&self, team: &Team, current_user_email: &str) -> Vec<Item> {
        ...
        team.pending_email_invites.iter().for_each(|email_invite| {
            ...
            let actions = if current_user_has_admin_permissions {
                vec![ItemAction {
                    icon: Icon::X,
                    label: i18n::t("settings.teams.members.cancel_invite").to_string(),
            ...
            if member.email != *current_user_email {
                ...
                if current_user_has_owner_permissions && !team_member_has_owner_permissions {
                    actions.push(ItemAction {
                        icon: Icon::Users,
                        label: i18n::t("settings.teams.members.transfer_ownership").to_string(),
                    ...
                    && !team_member_has_owner_permissions
                {
                    if team_member_has_admin_permissions {
                        actions.push(ItemAction {
                            icon: Icon::ArrowDown,
                            label: i18n::t("settings.teams.members.demote_from_admin").to_string(),
                        ...
                        actions.push(ItemAction {
                            icon: Icon::ArrowUp,
                            label: i18n::t("settings.teams.members.promote_to_admin").to_string(),
                            action: TeamsPageAction::SetTeamMemberRole {
                                team_uid: team.uid,
                                user_uid: member.uid,
                ...
                if current_user_has_admin_permissions && !team_member_has_owner_permissions {
                    actions.push(ItemAction {
                        icon: Icon::X,
                        label: i18n::t("settings.teams.members.remove_from_team").to_string(),
...
impl TeamsWidget {
    ...
    fn render_team_member_cost_info(
        ...
        let prorated_message = if has_admin_permissions {
            i18n::t("settings.teams.pricing.prorated_admin")
        } else {
            i18n::t("settings.teams.pricing.prorated_member")
        };
        ...
        {
            i18n::t("settings.teams.pricing.additional_members_with_cost")
            ...
            i18n::t("settings.teams.pricing.additional_members_no_cost")
                .replace("{prorated_message}", prorated_message)
        };
        ...
        let member_pricing_header = Container::new(self.render_subsection_header(
            i18n::t("settings.teams.pricing.team_members").to_owned(),
            appearance,
        ))
        ...
        match team.billing_metadata.delinquency_status {
            DelinquencyStatus::PastDue => {
                left_side.add_child(
                    Container::new(self.render_delinquency_badge(
                        appearance,
                        i18n::t("settings.teams.badge.past_due").into(),
            ...
            DelinquencyStatus::Unpaid => {
                left_side.add_child(
                    Container::new(self.render_delinquency_badge(
                        appearance,
                        i18n::t("settings.teams.badge.unpaid").into(),
        ...
        appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    ...
                    i18n::t("settings.teams.manage.contact_support"),
    ...
    fn render_manage_billing_button(
        ...
        appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    TextAndIconAlignment::IconFirst,
                    i18n::t("settings.teams.manage.manage_billing"),
    ...
    fn render_admin_panel_button(
        ...
        appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    TextAndIconAlignment::IconFirst,
                    i18n::t("settings.teams.manage.open_admin_panel"),
        ...
        if team.billing_metadata.customer_type == CustomerType::Enterprise {
            ...
            if team.billing_metadata.can_upgrade_to_higher_tier_plan() {
                let description = if team.billing_metadata.can_upgrade_to_build_plan() {
                    i18n::t("settings.teams.upgrade.to_build")
                } else {
                    match team.billing_metadata.customer_type {
                        CustomerType::Prosumer => i18n::t("settings.teams.upgrade.to_turbo"),
                        CustomerType::Turbo => i18n::t("settings.teams.upgrade.to_lightspeed"),
                        _ => i18n::t("settings.teams.upgrade.compare_plans"),
                    }
                };
                billing_links.add_child(
    ...
    fn render_plan_usage(
        ...
        let sub_header_text = match team.billing_metadata.customer_type {
            CustomerType::Free => i18n::t("settings.teams.plan.free_usage_limits"),
            _ => i18n::t("settings.teams.plan.usage_limits"),
        };
        ...
        if let Some(policy) = team.billing_metadata.tier.shared_notebooks_policy {
            if !policy.is_unlimited {
                ...
                shared_notebooks_column.add_child(self.render_plan_usage_header(
                    i18n::t("settings.teams.plan.shared_notebooks").into(),
                    appearance,
                ));
        ...
        if let Some(policy) = team.billing_metadata.tier.shared_workflows_policy {
            if !policy.is_unlimited {
                ...
                shared_workflows_column.add_child(self.render_plan_usage_header(
                    i18n::t("settings.teams.plan.shared_workflows").into(),
                    appearance,
                ));
    ...
    fn render_invite_by_link_section(
        ...
        invite_by_link_header_row.add_child(self.render_subsection_header(
            i18n::t("settings.teams.invite.by_link").to_owned(),
            appearance,
        ));
                ...
                section.add_child(
                    Align::new(
                        appearance
                            .ui_builder()
                            .link(
                                i18n::t("settings.teams.invite.reset_links").into(),
                                None,
    ...
    fn render_invite_by_email_section(
        ...
        section.add_child(
            Container::new(self.render_subsection_header(
                i18n::t("settings.teams.invite.by_email").to_owned(),
                appearance,
            ))
            .with_padding_top(CONTENT_SEPARATION_PADDING)
                    ...
                    let limit_hit_text = if team.billing_metadata.can_upgrade_to_higher_tier_plan()
                    {
                        ...
                        limit_hit_text_and_upgrade_button.add_child(
                            self.render_compare_plans_button(
                                i18n::t("settings.teams.upgrade.compare_plans"),
    ...
    fn render_team_members_section(
        ...
        section.add_child(
            SavePosition::new(
                Container::new(self.render_subsection_header(
                    i18n::t("settings.teams.members.header").to_owned(),
                    appearance,
                ))
    ...
    fn render_approved_domains_section(
        ...
        section.add_child(
            Container::new(self.render_sub_header(
                i18n::t("settings.teams.invite.restrict_by_domain").to_owned(),
                appearance,
            ))
            .with_padding_top(16.)
            .finish(),
        ...
        let domains_as_items: Vec<Item> = team
            ...
            .map(|domain_restriction| {
                let actions = if has_admin_permissions {
                    vec![ItemAction {
                        icon: Icon::X,
                        label: i18n::t("settings.teams.members.remove_domain").to_string(),
    ...
    fn render_discoverability_toggle_section(
        ...
        discoverable_header_row.add_child(
            Container::new(self.render_sub_header(
                i18n::t("settings.teams.discoverable.header").to_owned(),
                appearance,
            ))
            .with_padding_top(CONTENT_SEPARATION_PADDING)
            .finish(),
        ...
        let team_discoverability_instructions =
            i18n::t("settings.teams.discoverable.allow_domain").replace("{domain}", domain);
        section.add_child(
            Container::new(self.render_sub_text(
    ...
    fn render_delete_disabled_help_text(
        ...
        if delete_disabled_reason == TeamDeleteDisabledReason::ActivePaidSubscription {
            let link = appearance
                .ui_builder()
                .link(
                    i18n::t("settings.teams.manage.manage_plan").into(),
                    None,
                    Some(Box::new(move |ctx| {
                        ctx.dispatch_typed_action(
                            TeamsPageAction::GenerateStripeBillingPortalLink { team_uid },
                ...
                match item.state {
                    ItemState::Expired => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                i18n::t("settings.teams.badge.expired").into(),
                    ...
                    ItemState::Pending => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                i18n::t("settings.teams.badge.pending").into(),
                    ...
                    ItemState::Owner => {
                        pending_and_close_row.add_child(self.render_state_chip(
                            appearance,
                            i18n::t("settings.teams.badge.owner").into(),
                    ...
                    ItemState::Admin => {
                        pending_and_close_row.add_child(
                            self.render_state_chip(
                                appearance,
                                i18n::t("settings.teams.badge.admin").into(),
                                appearance
                                    .theme()
                                    .background()
    ...
    fn render_copy_link_row(
        ...
        let (link_text, button_enabled) = match &team_metadata.invite_code {
            ...
            None => (
                i18n::t("settings.teams.invite.failed_load_link").into(),
                false,
            ),
        };
        let theme = appearance.theme();
    ...
    fn render_create_team_page(
        ...
        page.add_child(render_sub_header(
            appearance,
            i18n::t("settings.teams.header").to_string(),
            None,
        ));
        page.add_child(self.render_sub_header_with_subtext_color(
            appearance,
            i18n::t("settings.teams.create.title").to_string(),
        ));
        page.add_child(
            Container::new(
        ...
        if view.auth_state.is_on_work_domain().unwrap_or_default() {
            ...
            let checkbox_row_text = if let Some(domain) = view.auth_state.user_email_domain() {
                i18n::t("settings.teams.create.discoverable_checkbox_domain")
                    .replace("{domain}", &domain)
            } else {
                i18n::t("settings.teams.create.discoverable_checkbox_generic").to_string()
            };
        ...
        if !view.discoverable_teams_states.is_empty() {
            ...
            page.add_child(self.render_sub_header_with_subtext_color(
                appearance,
                i18n::t("settings.teams.create.join_existing").to_string(),
            ));
    ...
    fn render_single_team_in_team_discovery(
        ...
        let teammate_string = if team_state.team.num_members == 1 {
            i18n::t("settings.teams.discovery.one_teammate").to_string()
        } else {
            i18n::t("settings.teams.discovery.multiple_teammates")
        ...
        single_team.add_child(
            Container::new(self.render_sub_text(
                i18n::t("settings.teams.discovery.join_description").to_string(),
                appearance,
                None,
            ))
            .with_padding_top(12.)
    ...
    fn render_join_team_button(
        ...
        if team_state.team.team_accepting_invites {
            self.render_button(
                i18n::t("settings.teams.discovery.join_button"),
                ButtonVariant::Accent,
            ...
            appearance
                ...
                .with_centered_text_label(
                    i18n::t("settings.teams.discovery.contact_admin").to_string(),
                )
                .disabled()
                .build()
                .finish()
