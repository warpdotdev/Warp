...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(Some(i18n::t("settings.privacy.add_regex_pattern").to_string()), add_regex_body, ctx)
    ...
    fn build_page() -> PageType<Self> {
        ...
        PageType::new_uncategorized(widgets, Some(i18n::t("settings.privacy")))
    }
...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let personal_tab = self.render_tab(
            i18n::t("settings.privacy.personal").to_string(),
            personal_count,
        ...
        let enterprise_tab = self.render_tab(
            i18n::t("settings.privacy.enterprise").to_string(),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                i18n::t("settings.privacy.enterprise.cannot_modify").to_string(),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(i18n::t("settings.privacy.enterprise.no_regexes"))
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
            ...
            column.add_child(
                Container::new(
                    Flex::row()
                        ...
                        .with_cross_axis_alignment(CrossAxisAlignment::Center)
                        .with_child(
                            self.render_section_title(i18n::t("settings.privacy.recommended").to_string(), appearance),
                        )
                        .with_child(
                            Container::new(
                                ui_builder
                                    ...
                                    .with_text_and_icon_label(Self::add_button(
                                        i18n::t("settings.privacy.add_all"), appearance,
                                    ))
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn render(
        ...
        let secret_redaction_title_row = Container::new(
            Flex::row()
                .with_child(
                    Shrinkable::new(
                        1.0,
                        render_sub_header(appearance, i18n::t("settings.privacy.safe_mode"), Some(local_only_icon_state)),
                    )
                    .finish(),
                )
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                i18n::t("settings.privacy.managed_by_org").to_string(),
                                appearance,
                            )
                        } else {
                            ui_builder
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.safe_mode.description").to_owned())
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                i18n::t("settings.privacy.secret_visual_mode").to_string(),
                None,
            ...
            let left_content = Flex::column()
                ...
                .with_child(
                    Container::new(
                        ui_builder
                            .paragraph(
                                i18n::t("settings.privacy.secret_visual_mode.description"),
                            )
                            .with_style(UiComponentStyles {
                                font_color: Some(description_text_color),
                                margin: Some(
                ...
                Flex::row()
                        ...
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    i18n::t("settings.privacy.user_secret_regex").to_string(),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    i18n::t("settings.privacy.user_secret_regex.description").to_owned(),
                                    appearance,
                    ...
                    .with_child(
                        ui_builder
                            ...
                            .with_text_and_icon_label(Self::add_button(i18n::t("settings.privacy.add_regex"), appearance))
                            .with_style(Self::add_button_style())
                            .build()
                            .on_click(move |ctx, _, _| {
        ...
        Hoverable::new(self.zdr_badge_mouse_state.clone(), move |mouse_state| {
            ...
            if is_hovered {
                let tooltip = ui_builder.tool_tip(
                    i18n::t("settings.privacy.zero_data_retention")
                        .to_string(),
                );
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn render(
        ...
        let description = if is_enterprise {
            i18n::t("settings.privacy.telemetry.description_old")
        } else {
            i18n::t("settings.privacy.telemetry.description")
        };
        ...
        let zdr_label_component = if self.should_show_zdr_badge(app) {
            Flex::row()
                ...
                .with_child(render_body_item_label::<PrivacyPageAction>(
                    i18n::t("settings.privacy.telemetry").into(),
                    None,
                    None,
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: i18n::t("settings.privacy.managed_by_org.tooltip").to_string(),
        ...
        if !is_on_paid_plan {
            column.add_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.telemetry.free_tier_note"))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
                        margin: Some(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        i18n::t("settings.privacy.telemetry.read_more").into(),
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.send_crash_reports").into(),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(
                        i18n::t("settings.privacy.send_crash_reports.description")
                            .to_owned(),
                    )
                    .with_style(UiComponentStyles {
                        font_color: Some(
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.store_ai_conversations").into(),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
            ...
            .with_child(
                ui_builder
                    .paragraph(
                        if is_checked {
                            i18n::t("settings.privacy.store_ai_conversations.enabled_description")
                        } else {
                            i18n::t("settings.privacy.store_ai_conversations.disabled_description")
                        }
                        .to_owned(),
                    )
                    .with_style(UiComponentStyles {
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.network_log_console").into(),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(
                        i18n::t("settings.privacy.network_log_console.description")
                            .to_owned(),
                    )
                    .with_style(UiComponentStyles {
                        font_color: Some(
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            i18n::t("settings.privacy.network_log_console.link").to_owned(),
                            None,
                            Some(Box::new(|ctx| {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.data_management").into(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                ui_builder
                    .paragraph(i18n::t("settings.privacy.data_management.description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            i18n::t("settings.privacy.data_management.link").into(),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                i18n::t("settings.privacy.privacy_policy").into(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            i18n::t("settings.privacy.privacy_policy.link").into(),
