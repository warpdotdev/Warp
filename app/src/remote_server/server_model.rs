...
use super::proto::{
    ...
    FragmentMetadata, GetFragmentMetadataFromHash, GetFragmentMetadataFromHashResponse,
    IndexCodebase, Initialize, InitializeResponse, MissingFragmentMetadata, NavigatedToDirectory,
