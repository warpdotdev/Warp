//! This module contains Rust types for the GenerateAIInputSuggestions endpoint in warp-server that
//! serves Agent Mode.
//!
//! These types are manually transposed from the API schema defined in go
//! (warp-server/model/types/generate_ai_input_suggestions/(request.go|response.go|common.go)).
//!
