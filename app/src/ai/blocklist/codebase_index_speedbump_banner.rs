    ...
    fn render_text_column(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = ui_builder
            .span(if self.visibility_state == VisibilityState::Speedbump {
                t!("code.index_codebase_title").to_string()
            } else {
                t!("code.indexing_codebase").to_string()
            })
        ...
        let body = ui_builder
            .span(t!("code.index_codebase_description").to_string())
            .with_style(UiComponentStyles {
    ...
    pub fn render_codebase_index_speedbump_banner(
        ...
        if self.visibility_state == VisibilityState::Speedbump {
            ...
            let checkbox_text = ui_builder
                .span(t!("code.allow_automatic_indexing").to_string())
                .with_style(UiComponentStyles {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(t!("common.dont_show_again").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(t!("code.index_codebase").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(t!("code.view_status").to_string())
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                                    padding: Some(Coords {
