...
impl AIContextMenuCategory {
    pub fn name(&self) -> &'static str {
        match self {
            Self::CurrentFolderFiles => "Files and folders",
            Self::RepoFiles => "Files and folders",
            ...
            Self::Diffs => "Diffs",
            Self::Docs => "Docs",
            Self::Tasks => "Past tasks",
            Self::Rules => "Rules",
            Self::Servers => "Servers and integrations",
            Self::Terminal => "Terminal",
            Self::Web => "Web",
            Self::RecentDiff => "Most recent diff",
            Self::RecentBlock => "Most recent block",
            Self::Code => "Code",
            Self::DiffSet => "Diff sets",
    ...
    pub fn icon(&self) -> &'static str {
        match self {
            Self::CurrentFolderFiles => "bundled/svg/folder.svg",
            Self::RepoFiles => "bundled/svg/folder.svg",
            Self::Commands => "bundled/svg/terminal.svg",
            Self::Blocks => "bundled/svg/terminal.svg",
            Self::Workflows => "bundled/svg/workflow.svg",
            Self::Notebooks => "bundled/svg/notebook.svg",
            Self::Plans => "bundled/svg/compass-3.svg",
            Self::Diffs => "bundled/svg/diff.svg",
            Self::Docs => "bundled/svg/docs.svg",
            Self::Tasks => "bundled/svg/tasks.svg",
            Self::Rules => "bundled/svg/book-open.svg",
            Self::Servers => "bundled/svg/server.svg",
            Self::Terminal => "bundled/svg/terminal.svg",
            Self::Web => "bundled/svg/web.svg",
            Self::RecentDiff => "bundled/svg/diff.svg",
            Self::RecentBlock => "bundled/svg/block.svg",
            Self::Code => "bundled/svg/code-02.svg",
            Self::DiffSet => "bundled/svg/diff.svg",
            Self::Conversations => "bundled/svg/conversation.svg",
            Self::Skills => "bundled/svg/stars-01.svg",
        }
    }
}
