...
impl GetStartedView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        let pane_configuration =
            ctx.add_model(|_ctx| PaneConfiguration::new(t!("pane_group.get_started").to_string()));
    ...
    fn render_main_content(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        Flex::column()
            ...
            .with_children([
                ...
                appearance
                    .ui_builder()
                    .paragraph(t!("pane_group.welcome_to_warp").to_string())
                ...
                Container::new(
                    appearance
                        .ui_builder()
                        .paragraph(t!("pane_group.agentic_development_environment").to_string())
                        .with_style(UiComponentStyles {
                            font_size: Some(14.),
...
impl BackingView for GetStartedView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::simple(t!("pane_group.get_started").to_string())
    }
