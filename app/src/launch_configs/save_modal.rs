...
impl LaunchConfigSaveModal {
    ...
    pub fn reset_editor(&mut self, ctx: &mut ViewContext<Self>) {
        self.editor.update(ctx, |editor, ctx| {
            ...
            editor.set_placeholder_text(t!("launch_config_save.filename_placeholder"), ctx);
        });
    }
    ...
    fn render_save_config_button(
        ...
        self.save_modal_button(
            appearance,
            t!("launch_config_save.save_configuration").to_string(),
    ...
    fn render_open_file_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        self.save_modal_button(
            appearance,
            t!("launch_config_save.open_yaml_file").to_string(),
        ...
        let info = match &self.save_state {
                    ...
                    self.render_formatted_text_line(
                        ...
                        vec![
                            FormattedTextFragment::plain_text(t!(
                                "launch_config_save.saved_to_start"
                            )),
            ...
            SaveState::NotSaved => {
                let text = if self.open_modal_keybinding_str.is_empty() {
                    t!("launch_config_save.not_saved_description").to_string()
                } else {
                    t!(
                        "launch_config_save.not_saved_description_with_keybinding",
                ...
                header
                    ...
                    .with_child(
                        self.render_formatted_text_line(
                            ...
                            vec![
                                FormattedTextFragment::plain_text(t!(
                                    "launch_config_save.yaml_saved_to_start"
                                )),
