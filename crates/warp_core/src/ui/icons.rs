...
pub enum Icon {
    ...
    CalloutTriangleBorderRight,
    CalloutTriangleFillRight,
    DragIndicator,
    Ellipse,
    Inbox,
    Menu01,
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::CalloutTriangleBorderRight => "bundled/svg/callout-triangle-border-right.svg",
            Icon::CalloutTriangleFillRight => "bundled/svg/callout-triangle-fill-right.svg",
