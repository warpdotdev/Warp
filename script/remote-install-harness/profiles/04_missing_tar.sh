# Profile: tar is not available on the remote host.
# The install script should fail at the tar extraction step.
PROFILE_USER="harness_notar"
PROFILE_EXPECTED="Failure at tar extraction; 'tar: command not found' or similar"
