...
项目 README 现在把这个 fork 明确称为 **Warp Refined**，并用 “Warp Refined vs. Official Warp” 单独说明它相比官方 Warp 多出的能力。以后补充或删改 fork 特性时，记得同步更新 `README.md` 和 `README_ZH.md`，保持英文版和中文版的信息一致；同时要保留“相比其他 fork 更少改动、不引入复杂无关功能、优先稳定性”的项目定位。
